                ...
                <div className="max-w-3xl">
                    ...
                    <div className="relative group">
                        ...
                        <input
                            ...
                            className="block w-full pl-12 sm:pl-14 pr-6 sm:pr-8 py-4 sm:py-5 bg-white border border-slate-200 rounded-xl sm:rounded-2xl focus:ring-[12px] focus:ring-primary/5 focus:border-primary outline-none transition-all font-bold text-slate-900 placeholder:text-slate-300 shadow-sm text-sm sm:text-base"
                            value={searchTerm}
                    ...
                    <div className="flex items-center space-x-2 overflow-x-auto pb-4 scrollbar-thin scrollbar-thumb-slate-200 scrollbar-track-transparent">
                        {belts.map((belt, i) => (
                            <motion.button
                                ...
                                className={`px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg sm:rounded-xl text-[10px] sm:text-[11px] font-black uppercase tracking-widest transition-all whitespace-nowrap border-2 ${selectedBelt === belt
                                ...
                                >
                                    ...
                                    <td className="px-8 py-5">
                                        <div className="flex justify-center space-x-2">
                                            {s.scholarship && (
                                                <span className="h-9 w-9 rounded-lg bg-orange-50 text-orange-500 border border-orange-100 flex items-center justify-center shadow-sm" title="Scholarship">
                                            ...
                                            {s.eligibleForTest && (
                                                <span className="h-9 w-9 rounded-lg bg-emerald-50 text-emerald-500 border border-emerald-100 flex items-center justify-center shadow-sm" title="Ready for Test">
                                    ...
                                    <td className="px-8 py-5 text-right">
                                        <button className="h-9 w-9 rounded-lg bg-slate-50 text-slate-300 group-hover:bg-primary group-hover:text-white transition-all duration-300 flex items-center justify-center ml-auto">
                ...
                <div className="md:hidden space-y-4">
                    {filteredStudents.map((s) => (
                        <motion.div
                            ...
                            key={s.id}
                            onClick={() => { setCurrentStudent(s); setIsDetailOpen(true); }}
                            className="bg-white p-4 sm:p-5 rounded-xl border border-slate-200 shadow-sm active:scale-[0.98] transition-all flex items-center space-x-3 sm:space-x-4 group"
                        >
                            <div className="relative">
                ...
                {isDetailOpen && (
                    <div className="fixed inset-0 z-[100] flex items-center justify-center lg:p-12 overflow-hidden">
                        ...
                        <motion.div
                            ...
                            className="relative bg-white rounded-t-3xl lg:rounded-2xl shadow-2xl w-full max-w-4xl max-h-[95vh] lg:max-h-[90vh] overflow-hidden flex flex-col mt-auto lg:mt-0"
                        >
                            <header className="px-5 py-5 md:px-10 md:py-8 border-b border-slate-100 flex items-center justify-between bg-white relative z-10 pt-[calc(1rem+env(safe-area-inset-top))] lg:pt-8">
                                ...
                                <button onClick={() => setIsDetailOpen(false)} className="h-10 w-10 md:h-12 md:w-12 rounded-2xl bg-slate-50 text-slate-300 flex items-center justify-center hover:bg-slate-900 hover:text-white transition-all group active:scale-95">
                                    ...
                                    <div className="lg:col-span-2 space-y-8 md:space-y-12">
                                        <section className="space-y-6">
                                            ...
                                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                {[
                                                    ...
                                                    <div key={info.label} className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm hover:border-primary/20 transition-colors group">
                                        ...
                                        <section className="space-y-6">
                                            ...
                                            <div className="grid grid-cols-2 gap-4">
                                                {[
                                                    { label: 'Height', value: currentStudent.height ? `${currentStudent.height} cm` : '—', icon: '📏' },
                                                    { label: 'Weight', value: currentStudent.weight ? `${currentStudent.weight} kg` : '—', icon: '⚖️' },
                                                ].map((bio) => (
                                                    <div key={bio.label} className="bg-blue-50/30 p-5 rounded-2xl border border-blue-50/50 shadow-sm transition-colors group">
                                                        <div className="flex items-center justify-between mb-2">
                                                    ...
                                                    <div className="space-y-4">
                                                        ...
                                                        <div className="flex items-center space-x-2">
                                                            {[1, 2, 3, 4].map((s) => (
                                                                <div
                                                                    key={s}
                                                                    className={`h-8 w-8 rounded-lg flex items-center justify-center text-[10px] font-black transition-all ${currentStudent.stripes === s ? 'bg-amber-500 text-white shadow-lg shadow-amber-500/30' : 'bg-white/10 text-slate-500'}`}
                                                                >
                                                                    {s}
                                                                </div>
                                                            ))}
                                    ...
                                    <div className="space-y-8 md:space-y-12">
                                        <div className="bg-slate-50 p-6 rounded-3xl border border-slate-100 flex flex-col items-center justify-center text-center space-y-4">
                                            ...
                                            <button
                                                ...
                                                className="w-full py-4 bg-slate-900 text-white rounded-xl font-black text-[10px] uppercase tracking-[.25em] hover:bg-slate-800 transition-colors shadow-lg shadow-slate-900/20"
                                            >
                                                Edit Student
                                            </button>
                                        </div>
                                        ...
                                        {currentStudent.eSignId && (
                                            <div className="space-y-4">
                                                ...
                                                <div className="p-4 bg-white rounded-3xl border border-slate-100 flex items-center justify-center overflow-hidden min-h-[120px]">
                                                    <img
                ...
                {isEditModalOpen && (
                    <div className="fixed inset-0 z-[110] flex items-center justify-center lg:p-12 overflow-hidden">
                        ...
                        <motion.div
                            ...
                            className="relative bg-white rounded-t-3xl lg:rounded-2xl shadow-2xl w-full max-w-2xl max-h-[95vh] lg:max-h-[90vh] overflow-hidden flex flex-col mt-auto lg:mt-0"
                        >
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <div className="space-y-6">
                                        <div className="flex items-center space-x-4">
                                            <div className="h-12 w-12 bg-blue-50 rounded-2xl flex items-center justify-center text-2xl shadow-sm">🥋</div>
                                            <div>
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            <div className="col-span-2 md:col-span-1 space-y-2">
                                                ...
                                                <div className="w-full px-5 py-4 bg-slate-50 border border-slate-100 rounded-2xl text-sm font-black text-slate-800">
                                            ...
                                            <div className="col-span-2 md:col-span-1 space-y-2">
                                                ...
                                                <div className="w-full px-5 py-4 bg-slate-50 border border-slate-100 rounded-2xl flex items-baseline space-x-2">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <div className="w-full px-5 py-4 bg-slate-50 border border-slate-100 rounded-2xl text-sm font-medium text-slate-600 min-h-[80px]">
                                    ...
                                    {/* BIOMETRICS SECTION */}
                                    <div className="bg-blue-50/40 p-8 rounded-3xl border border-blue-100/50 space-y-8 flex flex-col">
                                        <div className="flex items-center space-x-4">
                                            <div className="h-12 w-12 bg-white rounded-2xl flex items-center justify-center text-xl shadow-sm border border-blue-50">📏</div>
                                            <div>
                                            ...
                                            <div className="space-y-2.5">
                                                ...
                                                <div className="relative group">
                                                    <input
                                                        type="number"
                                                        placeholder="0"
                                                        className="w-full pl-5 pr-12 py-4 bg-white border border-blue-100/80 rounded-2xl outline-none focus:border-blue-400 focus:ring-8 focus:ring-blue-500/5 transition-all text-xl font-black text-slate-700"
                                                        value={currentStudent.height || ''}
                                                        onChange={(e) => setCurrentStudent({ ...currentStudent, height: parseFloat(e.target.value) })}
                                                    />
                                            ...
                                            <div className="space-y-2.5">
                                                ...
                                                <div className="relative group">
                                                    <input
                                                        ...
                                                        onChange={(e) => setCurrentStudent({ ...currentStudent, weight: parseFloat(e.target.value) })}
                                                    />
                                ...
                                <div className="p-6 bg-slate-50/50 rounded-3xl border border-slate-100 space-y-4">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div className="space-y-2">
                                            ...
                                            <input
                                                className="w-full px-5 py-3 bg-white border border-slate-200 rounded-xl outline-none font-mono text-[11px] text-slate-500 focus:border-primary focus:ring-4 focus:ring-primary/5 transition-all"
                            ...
                            <footer className="px-10 py-8 bg-white border-t border-slate-100 flex items-center justify-end space-x-6 sticky bottom-0 z-20 pb-[calc(2rem+env(safe-area-inset-bottom))] lg:pb-8 backdrop-blur-xl bg-white/90">
                                ...
                                <button
                                    onClick={handleSave}
                                    disabled={saving}
                                    className="px-12 py-5 bg-primary text-white rounded-2xl font-black text-[11px] uppercase tracking-[.3em] shadow-2xl shadow-primary/30 active:scale-95 disabled:opacity-50 transition-all flex items-center space-x-3"
                                >
                                    {saving ? (
